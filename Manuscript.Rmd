...
In order to estimate the stability of these partitions over time, we performed a sliding window analysis on each subject's full time series (20 min windows shifting by 1 min); comparing the partitioning derived from each windowed time series with the partitioning computed using the entire time series (Figure 4). 

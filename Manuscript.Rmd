...
- Joe:
  - something to potentially discuss later in the paper: for this to be maximally useful in the future, it would help if a general threshold can be
    identified (without having to do the windowed analysis on every subject). Looking at the amount variability in the per-subject thresholds might give us 
    a sense of whether that's possible. 

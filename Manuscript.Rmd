...
corrplot(RI_PFC, 
         ...
         mar = c(1,0,2,0), 
         add = T)
mtext(expression(bold("Subject Partitions")), line = 0.8)
mtext(expression(bold("Subject Partitions")), side = 2, line = -2.5)
mtext(expression(bold("PFC")), line = 0, at = par("usr")[1]+0.7*diff(par("usr")[1:2]), col = "steelblue4")
mtext(expression(bold("PCC")), side = 1, line = 4, at = par("usr")[1]+0.22*diff(par("usr")[1:2]), col = "steelblue4")
...
corrplot(RI_all_between_halves, 
         ...
         cl.length = 3,
         mar = c(1,1,1,1))
mtext("Subjects (Day 1 and Day 2)", line = 0)
mtext("Subjects (Day 1 and Day 2)", side = 2, line = 3)
...
``` {r Noise Effects: Per-subject Fiedler by R-sqd (Fig. 13), fig.align="center", fig.width=3, fig.height=3, fig.cap = "Figure 13. Fiedler vector values are linearly related to the total variance explained by each vertex with respect to the mean DMN time series.", echo=FALSE, message = FALSE, cache = TRUE}
setwd('./Variance/')
temp <- list.files()

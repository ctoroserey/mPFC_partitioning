...
```{r Extra examples (supplemental fig 3), out.width = "100%", fig.align = "center", fig.cap = "Signal quality prior to FV thresholding. Left: Surface map displaying the vertex-wise mean tSNR across individuals. Right: Mean tSNR for mPFC and PCC across individuals."}
# To get the box plot:
#   
# allSnr <- list()
# 

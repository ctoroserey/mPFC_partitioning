...
In order to evaluate the stability and topographical heterogeneity of the communities within and across individuals, we chose the adjusted rand index (ARI) as a reference metric of agreement between two partitionings [@Hubert1985]. The base of the ARI is computed by the formula
...
- Stability within subject has also been showsn before (Gratton2018b). This work was done using parcellations and oversampling though.

...
## Significance Statement
  ...
  Multiple psychological functions engage topographically overlapping regions of human medial prefrontal cortex (mPFC), and the reason for the apparent overlap is not yet well understood. Here we present evidence that our understanding of the functional organization of mPFC can be advanced by accounting for individual-level topographic variability. We report results from a data-driven, network-based approach to subdividing mPFC and posterior cingulate cortex jointly into two distinct communities on the basis of non-task functional neuroimaging data. One of the identified communities corresponded to the brain's canonical default network. The community structure of mPFC was stable across test/re-test but exhibited high variability across individuals. The approach we introduce will help characterize the functional role of mPFC across diverse psychological domains.

...
```{r Meta-analysis ROIs (Fig. 1), out.width = "50%", fig.align = "center", fig.cap= "Meta-analysis results. A: Proportion of times each ROI was reported in the valuation and DN literatures. B: Regions identified in permutation-based chi-squared tests contrasting the two literatures. Area 25 (in red) was disregarded because of the possible confound with projections from spheres located in ventral striatum (see text for details). Areas in blue represent the remainder of the search space."}
...
```{r tSNR (supplemental fig 3), out.width = "100%", fig.align = "center", fig.cap = "Signal quality prior to FV thresholding. Left: Surface map displaying the vertex-wise mean tSNR across individuals. Right: Mean tSNR for mPFC and PCC across individuals."}
# To get the box plot:
#   
# allSnr <- list()
# 

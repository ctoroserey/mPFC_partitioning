...
Our results are complementary with previous studies that described individual-specific brain organization using a different data aspect ratio [fewer individuals and more data per individual; Gordon, Braga, Poldrack]. While inter-individual differences in functional topography have been described in these studies, here we were able to quantify the variability in a large sample. and our method does not require massively multi-session data acquisition. 

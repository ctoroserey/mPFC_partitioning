...
## Introduction
  ...
  However, to draw firm conclusions about functional overlap will require a better understanding of individual-level heterogeneity in topographic patterns of brain activity. A key limitation of group averaging and meta-analysis is that individual-specific functional subdivisions can be blurred and overlooked [@Michalka2015; @Fedorenko2012; Woo2014], potentially exaggerating the degree of overlap across domains. This concern is especially pronounced in mPFC, which is subject to considerable idiosyncratic cortical folding [@Zilles2013; @Mackey2014] and inter-subject functional variability [@Mueller2013a]. An alternative approach is to focus on analyses at the individual-participant level. Individual-level analyses of fMRI data have identified idiosyncratic, reliable, and valid patterns of functional organization that would be blurred in aggregative estimates [@Laumann2015; @Gordon2017; @Gratton2018a; @Tobyne2018]. Subject-specific network arrangements have been found to predict behavioral characteristics [@Kong2018]. Recent work has uncovered fine-grained subdivisions within the DMN through tailored analyses of seed-based functional connectivity [@Braga2017]. It is therefore possible that the diffuse overlap of DMN and valuation effects can be attributed to a lack of spatial resolution, and that the organization of mPFC and PCC would be better understood at the individual level. An important first step, and the goal of the present paper, is to quantify the degree of topographic heterogeneity of DMN effects within mPFC and PCC.

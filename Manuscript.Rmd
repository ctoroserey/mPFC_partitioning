...
```{r extra B&B checks with silhouette (supplemental fig 4), out.width = "100%", fig.align = "center", fig.cap = "Additional checks to confirm the match between our findings with Braga & Buckner (2017)."}

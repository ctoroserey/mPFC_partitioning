...
ggplot(data = Halves_RIRatios_summary, aes(Region, RI, fill = Region)) + 
  geom_violin(show.legend = F, draw_quantiles = 0.5, trim = F, lwd = 0.7) +
...
### *Stability per subject (sliding window)*

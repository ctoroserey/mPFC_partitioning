...
# Select a subsection of participants for plotting
Summaries_halves_plot <- Summaries_halves[selectSubj]
unthreshComm_PFC_halves_plot <- lapply(Summaries_halves_plot, "[", i = !posteriorIndx, j =)
unthreshComm_PFC_halves <- lapply(Summaries_halves, "[", i = !posteriorIndx, j =)
...
best <- tmp %>% top_n(10, wt = DailyARI) %>% arrange(DailyARI)
...
Correlation_halves_plot <- Correlation_halves[bestindx] # CHANGE TO THE ACTUAL SUBJECTS
```
